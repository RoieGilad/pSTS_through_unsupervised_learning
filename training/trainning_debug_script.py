...
class SimpleModel(nn.Module):
    ...
    def load_model(self, dir_to_load):
        path_to_save = path.join(dir_to_load, "model.pt")
...
if __name__ == '__main__':
    ...
    snapshot_path = r'C:\Users\AVIV\Roie\Galit_Project\pSTS_through_unsupervised_learning\training\debugging'
    dir_best_model = r'C:\Users\AVIV\Roie\Galit_Project\pSTS_through_unsupervised_learning\training\best_debugging'
    ...
    trainer = Trainer(model, train_params, 10, snapshot_path, dir_best_model, False, training_utils.run_simple_batch,device , nept)
